<template>
  <main class="content container" v-if="productsLoading">Зфгрузка товара...</main>
          ...
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              <div class="form__counter">
                <button type="button" aria-label="Убрать один товар" @click="lessProduct">
                  <svg width="12" height="12" fill="currentColor">
                    <use xlink:href="#icon-minus"></use>
                  </svg>
                </button>

                <input type="text" pattern="^[1-9]\d*$" v-model.number="productAmout" />
...
export default {
  ...
  methods: {
    ...
    addToCart() {
      ...
      this.addProductToCart({productId: this.product.id, amount: this.productAmout})
          .then(() => {
